...
public class Matrix4x3dStack extends Matrix4x3d {
   ...
   public Matrix4x3dStack(int var1) {
      if (var1 < 1) {
         throw new IllegalArgumentException("stackSize must be >= 1");
      } else {
         this.mats = new Matrix4x3d[var1 - 1];

         for(int var2 = 0; var2 < this.mats.length; ++var2) {
            this.mats[var2] = new Matrix4x3d();
         }
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         if (var1 instanceof Matrix4x3dStack) {
            Matrix4x3dStack var2 = (Matrix4x3dStack)var1;
   ...
   public void readExternal(ObjectInput var1) throws IOException {
      ...
      for(int var2 = 0; var2 < this.curr; ++var2) {
         Matrix4x3d var3 = new Matrix4x3d();
