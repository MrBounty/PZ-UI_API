...
public class Matrix3x2dStack extends Matrix3x2d {
   ...
   public Matrix3x2dStack(int var1) {
      if (var1 < 1) {
         throw new IllegalArgumentException("stackSize must be >= 1");
      } else {
         this.mats = new Matrix3x2d[var1 - 1];

         for(int var2 = 0; var2 < this.mats.length; ++var2) {
            this.mats[var2] = new Matrix3x2d();
         }
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         if (var1 instanceof Matrix3x2dStack) {
            Matrix3x2dStack var2 = (Matrix3x2dStack)var1;
   ...
   public void readExternal(ObjectInput var1) throws IOException {
      ...
      for(int var2 = 0; var2 < this.curr; ++var2) {
         Matrix3x2d var3 = new Matrix3x2d();
