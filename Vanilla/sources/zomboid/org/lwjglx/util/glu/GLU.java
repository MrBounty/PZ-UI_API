...
public class GLU {
   ...
   public static boolean gluProject(float var0, float var1, float var2, FloatBuffer var3, FloatBuffer var4, IntBuffer var5, FloatBuffer var6) {
      return Project.gluProject(var0, var1, var2, var3, var4, var5, var6);
   }
   ...
   public static int gluScaleImage(int var0, int var1, int var2, int var3, ByteBuffer var4, int var5, int var6, int var7, ByteBuffer var8) {
      return MipMap.gluScaleImage(var0, var1, var2, var3, var4, var5, var6, var7, var8);
   }

   public static String gluErrorString(int var0) {
      switch(var0) {
      case 100900:
      ...
      default:
         return org.lwjglx.opengl.Util.translateGLErrorString(var0);
      }
   }
