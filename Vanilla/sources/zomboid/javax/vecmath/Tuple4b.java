...
public abstract class Tuple4b implements Serializable, Cloneable {
   ...
   public String toString() {
      int var10000 = this.x & 255;
      return "(" + var10000 + ", " + (this.y & 255) + ", " + (this.z & 255) + ", " + (this.w & 255) + ")";
   }
   ...
   public final void setX(byte var1) {
      this.x = var1;
   }
   ...
   public final void setY(byte var1) {
      this.y = var1;
   }
   ...
   public final void setZ(byte var1) {
      this.z = var1;
   }
   ...
   public final void setW(byte var1) {
      this.w = var1;
   }
}
